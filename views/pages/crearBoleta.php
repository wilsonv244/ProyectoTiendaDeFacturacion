        ...
        <div class="i-personal">
            ...
            <div class="datoC">
                ...
                <div class="dato">
                    ...
                    <input type="disable" id="nombre-producto" name="propiedad[precio]" placeholder="Nombre del Producto" value="" />
                </div>
                <div class="datosCliente">
                    <div class="dato">
                    ...
                    <div class="dato">
                        ...
                        <input type="number" name="propiedad[descripcion]" id="cantidad-producto" value="1" placeholder="Cantidad de Producto"/>
                    </div>
                </div>
